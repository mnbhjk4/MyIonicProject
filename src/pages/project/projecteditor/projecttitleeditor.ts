...
@Component({
  template: `
    <ion-grid>
        ...
        <ion-row>
            <div class="projecttitleditor-confirm">
...
export class ProjectTitleEditorComponent {
    ...
    constructor(public viewCtrl: ViewController) {
        this.project = this.viewCtrl.data["project"];
        this.projectName = this.project.statusList[0].projectName;
        this.priority = this.project.statusList[0].priority;
    }

    ok(){
        this.project.statusList[0].projectName = this.projectName;
        this.project.statusList[0].priority = this.priority;
